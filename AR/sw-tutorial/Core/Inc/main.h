...
#define pop2_Pin GPIO_PIN_2
#define pop2_GPIO_Port GPIOC
#define pop1_Pin GPIO_PIN_3
#define pop1_GPIO_Port GPIOC
...
#define notwork_Pin GPIO_PIN_14
#define notwork_GPIO_Port GPIOB
#define CAM_RCLK_Pin GPIO_PIN_15
#define CAM_RCLK_GPIO_Port GPIOB
#define NOTWORK_Pin GPIO_PIN_6
#define NOTWORK_GPIO_Port GPIOC
