...
void can_ctrl_loop() {
	/* ======= TX ======= */
	// CAN1
	can_transmit(&hcan1, RM_TX_GRP1_ID, rm_ctrl_cmd[CAN1_MOTOR1], rm_ctrl_cmd[CAN1_MOTOR2], rm_ctrl_cmd[CAN1_MOTOR3],
				 rm_ctrl_cmd[CAN1_MOTOR4]);
	can_transmit(&hcan1, RM_TX_GRP2_ID, rm_ctrl_cmd[CAN1_MOTOR5], rm_ctrl_cmd[CAN1_MOTOR6], rm_ctrl_cmd[CAN1_MOTOR7],
				 rm_ctrl_cmd[CAN1_MOTOR8]);

	// CAN2
	can_transmit(&hcan2, RM_TX_GRP1_ID, rm_ctrl_cmd[CAN2_MOTOR1], rm_ctrl_cmd[CAN2_MOTOR2], rm_ctrl_cmd[CAN2_MOTOR3],
				 rm_ctrl_cmd[CAN2_MOTOR4]);
	can_transmit(&hcan2, RM_TX_GRP2_ID, rm_ctrl_cmd[CAN2_MOTOR5], rm_ctrl_cmd[CAN2_MOTOR6], rm_ctrl_cmd[CAN2_MOTOR7],
				 rm_ctrl_cmd[CAN2_MOTOR8]);
